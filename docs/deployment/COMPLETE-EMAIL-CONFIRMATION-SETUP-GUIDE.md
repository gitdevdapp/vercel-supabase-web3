...
```
https://mjrnzgunexmopvnamggw.supabase.co/auth/v1/verify?token=...
```
...
1. **Navigate to**: https://supabase.com/dashboard/project/mjrnzgunexmopvnamggw
...
```
https://mjrnzgunexmopvnamggw.supabase.co/auth/v1/verify?token=pkce_abc123&type=signup&redirect_to=https://devdapp.com
```
...
**Symptoms**:
- New emails still contain `mjrnzgunexmopvnamggw.supabase.co` URLs
